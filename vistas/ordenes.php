...
<div class="container mt-5">
    <div class="row">
        <div class="col">
            <a class="btn btn-primary" href="reporteCotizacion.php" target="new" style="margin-bottom: 22px;"><i class="fa fa-file"></i> Imprimir reporte de ventas</a>
                ...
                <tbody>
                    ...
                    foreach ($ordenes as $row => $item) {
                        echo '<tr>
                            ...
                            <td>';
                        if ($item[6] == "Pendiente") {
                            echo '<a class="btn btn-primary" title="Listo!" href="index.php?seccion=ordenes&idOrden=' . $item[0] . '&listo=1"><i class="fa fa-check" aria-hidden="true"></i></a>
                            ';
                        }
                        echo '    <a class="btn text-center" href="pdf.php?id_orden=' . $item[0] . '&id_usuario=' . $item[4] . '" target="new">
