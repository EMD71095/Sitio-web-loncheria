...
<head>
  <meta charset="utf-8">
  <title>Crear cuenta | Guerrerito</title>
  <meta charset="utf-8">
              ...
              <div class="infos">
                <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                  <div class="mb-3">
                    ...
                    <input required name="nombre" type="text" class="form-control" id="nombreUsuario" aria-describedby="nom" autocomplete="new-password">
                  </div>
                  <div class="mb-3">
